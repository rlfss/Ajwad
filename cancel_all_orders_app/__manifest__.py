# -*- coding: utf-8 -*-
{
	...
	'summary': " This app helps user to cancel all orders in odoo like sale, purchase, invoice, and picking and received and delivered product quantity will reverse. ",
	'description': """ 
					This app helps user to cancel all orders in odoo like sale, purchase, invoice, and picking and received and delivered product quantity will reverse.					 
